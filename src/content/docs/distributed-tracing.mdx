...
1. **Verify distributed tracing is working**
   ...
   Navigate to a product page in your app ([http://localhost:4173](http://localhost:4173))
...
2. **Find a pageload transaction**
   ...
   <ScaledImage
     src="/assets/img/distributed-trace-pageload.png"
     alt="A pageload transaction in Sentry Explore"
   />
