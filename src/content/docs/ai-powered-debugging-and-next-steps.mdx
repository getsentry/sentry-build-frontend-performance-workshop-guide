...
Seer is Sentry's AI debugging assistant that automates the analysis workflow you've been doing manually throughout this workshop.

It uses the same data you used:
...
## Seer in Action: The N+1 Query from Module 3

Remember how you manually analyzed the N+1 query in Module 3? Let's see how Seer would have automated that same workflow.
...
- **Module 5 - AI & Production**: Set up GitHub integration and learned how Seer automates debugging workflows
...
🤖 **AI tools like Seer** accelerate debugging by automating analysis, but you still need to understand the fundamentals to validate their suggestions
...
- **Try Seer on your codebase**: Connect your repositories and see what performance issues it finds
